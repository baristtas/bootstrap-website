      ...
      <div class="container">
         <div class="row">
            ...
            <h4 class="mt-4 mb-4">Kullanıcı Adınızı ve Şifreyi giriniz</h4> 
               <form  role = "form" 
                  action = "logTrue.php" method = "post">
                  <input type = "text"  
                     name = "username" placeholder = "Kullanıcı adı = burak" 
                     required class="mb-1"></br>
                  <input type = "password" 
                     name = "password" placeholder = "Şifre = 1234" required class="mb-1"><br>
